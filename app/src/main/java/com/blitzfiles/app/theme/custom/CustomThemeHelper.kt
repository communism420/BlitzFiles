...
import com.blitzfiles.app.compat.recreateCompat
import com.blitzfiles.app.compat.setThemeCompat
import com.blitzfiles.app.compat.themeResIdCompat
import com.blitzfiles.app.settings.Settings
import com.blitzfiles.app.theme.night.NightModeHelper
import com.blitzfiles.app.util.SimpleActivityLifecycleCallbacks
...
object CustomThemeHelper {
    ...
    private fun getCustomThemeRes(@StyleRes baseThemeRes: Int, context: Context): Int {
        ...
        val customThemeName = if (Settings.MATERIAL_DESIGN_3.valueCompat) {
            val defaultThemeName = resources.getResourceEntryName(R.style.Theme_BlitzFiles)
            val material3ThemeName =
                resources.getResourceEntryName(R.style.Theme_BlitzFiles_Material3)
