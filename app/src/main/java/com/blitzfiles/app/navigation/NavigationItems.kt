...
import com.blitzfiles.app.about.AboutActivity
...
private val menuItems: List<NavigationItem>
    ...
    get() = listOf(
        IntentMenuItem(
            R.drawable.global_search_icon_white_24dp, R.string.navigation_global_search,
            GlobalSearchActivity::class.createIntent()
        ),
        IntentMenuItem(
